...
export default function Info() {
  return (
    <div>
      ...
      <Typography paragraph>It‘s based on how many cases are probably in your area, and the likelihood that at least one of your employees catches it. It has lots of assumptions, but all the data is here so you can play with the assumptions to adapt them to your situation. You only <strong>need</strong> to make changes to the first tab; the rest are data inputs that you can change too.</Typography>
